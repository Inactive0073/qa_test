...
#     driver.get(url)
#     elems = driver.find_elements(By.CLASS_NAME, 'text')
#     res = sum(map(int,[el.find_element(By.XPATH, './p[2]').text for el in elems]))
#     print(res)


# with webdriver.Chrome() as driver:
#     driver.get(url)
#     inputs = driver.find_elements(By.CLASS_NAME, 'check')
#     for el in inputs:
#         el.click()
#     driver.find_element(By.CLASS_NAME, 'btn').click()
#     n = driver.find_element(By.ID, 'result')
#     print(n.text)
...
# with webdriver.Chrome() as driver:
#     driver.get(url)
#     for el in driver.find_elements(By.CLASS_NAME, 'check'):
...
# with webdriver.Chrome() as driver:
#     driver.get(url)
#     value = str(sum((int(el.text) for el in driver.find_elements(By.TAG_NAME, 'option'))))
#     driver.find_element(By.ID, 'input_result').send_keys(value)
...
with webdriver.Chrome() as driver:
    driver.get(url)
    r = ((12434107696 * 3) * 2) + 1
    for el in driver.find_elements(By.TAG_NAME, 'option'):
        if el.text == str(r):
            el.click()
            break
    driver.find_element(By.ID, 'sendbutton').click()
